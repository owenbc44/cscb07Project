                  ...
                  while (!(adminPageOption.equals("0") || adminPageOption.equals("9"))) {
                    ...
                    try {
                      ...
                      if (adminPageOption.equals("1")) {
                        ...
                        System.out.println(
                            "Please enter the file location and name you want to deserialize");
                        String fileLocationAndName = bufferedReader.readLine();
                        boolean clearDatabase = DatabaseDriver.clearDatabase();
                        if (clearDatabase) {
                          Deserialization.insertTheNewDatabase((DatabaseInOneObject) Deserialization
                              .deserialize(fileLocationAndName));
                          System.out.println("Deserialization complete!");

                        } else {
                          System.out
                              .println("Remove the old database unsuccessfully, please try again!");
